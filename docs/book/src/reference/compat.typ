...
#show: book-page.with(title: "Typst Compatibility")
...
#table(
  columns: 3,
  table.header[Typst][Tytanic][Note],
  table.hline(),

  [`<= v0.11.1`],     [none],               [unsupported],
  [`== v0.12.0`],     [`v0.1.0 .. v0.1.3`], none,
  [`== v0.13.0-rc1`], [`v0.2.0-rc1`],       none,
  [`== v0.13.0`],     [`v0.2.0 .. v0.2.2`], none,
