...
pub struct WorldProvider {
    ...
    augmented_library_provider: OnceLock<Arc<LibraryProvider>>,
    standard_library_provider: OnceLock<Arc<LibraryProvider>>,
...
impl WorldProvider {
    ...
    pub fn new() -> Self {
        Self {
            ...
            augmented_library_provider: OnceLock::new(),
            standard_library_provider: OnceLock::new(),
...
impl WorldProvider {
    ...
    fn augmented_library_provider(&self) -> Arc<LibraryProvider> {
        self.augmented_library_provider
            .get_or_init(|| Arc::new(LibraryProvider::with_library(augmented_default_library())))
            .clone()
    }

    fn standard_library_provider(&self) -> Arc<LibraryProvider> {
        self.standard_library_provider
