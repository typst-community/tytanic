...
/// # Example
/// ```no_run
/// # use tytanic_core::stdx::fs::create_dir;
/// create_dir("foo", true)?;
...
/// # Example
/// ```no_run
/// # use tytanic_core::stdx::fs::remove_file;
/// remove_file("foo.txt")?;
...
/// # Example
/// ```no_run
/// # use tytanic_core::stdx::fs::remove_dir;
/// remove_dir("foo", true)?;
...
/// # Example
/// ```no_run
/// # use tytanic_core::stdx::fs::create_empty_dir;
...
/// ```no_run
/// # use std::path::Path;
/// # use tytanic_core::stdx::fs::common_ancestor;
/// assert_eq!(
...
/// # Example
/// ```no_run
/// # use tytanic_core::stdx::fs::is_ancestor_of;
