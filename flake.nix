...

{
  inputs = {
    ...
    rust-manifest = {
      url = "https://static.rust-lang.org/dist/channel-rust-1.95.toml";
      flake = false;
    };
  };
      ...
      perSystem =
        ...
        in
        {
          ...
          checks = {
            ...
            tytanic-clippy = craneLib.cargoClippy (
              commonCraneArgs
              // {
                inherit cargoArtifacts;
            ...
            tytanic-test = craneLib.cargoTest (
              commonCraneArgs
              // {
                inherit cargoArtifacts;
